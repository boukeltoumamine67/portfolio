...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    fr: {
      ...
      cert_heading: "Certifications & Activities",
      ...
      svc3_text: "Intégration seamless d'API REST avec Dio, flux d'authentification, services Firebase et solutions de stockage local.",
